                ...
                <form class="forms-sample" action="{{ route('subsalons.update', $subsalon->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="working_days[]" id="working_days" multiple required>
                            @foreach (['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'] as $day)
                                <option value="{{ $day }}" {{ in_array($day, $workingDays) ? 'selected' : '' }}>{{ $day }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline">
                            ...
                            <select name="opening_hours_start_ampm" id="opening_hours_start_ampm" required>
                                <option value="AM" {{ date('A', strtotime($subsalon->opening_hours_start)) == 'AM' ? 'selected' : '' }}>AM</option>
                                <option value="PM" {{ date('A', strtotime($subsalon->opening_hours_start)) == 'PM' ? 'selected' : '' }}>PM</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline">
                            ...
                            <select name="opening_hours_end_ampm" id="opening_hours_end_ampm" required>
                                <option value="AM" {{ date('A', strtotime($subsalon->opening_hours_end)) == 'AM' ? 'selected' : '' }}>AM</option>
                                <option value="PM" {{ date('A', strtotime($subsalon->opening_hours_end)) == 'PM' ? 'selected' : '' }}>PM</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="type" id="type" required>
                            <option value="women" {{ $subsalon->type == 'women' ? 'selected' : '' }}>Women Only</option>

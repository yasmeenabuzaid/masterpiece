...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('users.create') }}">
            <button type="button" class="btn btn-success"><i class="fa-solid fa-plus" style="margin-right: 5px"></i> Add New Super Admin</button>
        </a>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                @if($users->isEmpty())
                    <tr>
                        <td colspan="6" class="text-center">No Super Admins Available</td>
                    </tr>
                @else
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->created_at->format('Y-m-d') }}<br>{{ $user->created_at->format('H:i') }}</td>
                            <td>

...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('users.create') }}">
            <button type="button" class="btn btn-gradient-success  btn-fw"><i class="fa-solid fa-plus" style="margin-right: 5px"></i>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img src="{{ $user->image ? asset($user->image) : 'default-image-path.jpg' }}" class="me-2" alt="image" style="border-radius: 3px; width: 50px;">
                    </td>
                    <td>
                      {{ $user->name }}
                    </td>
                    ...
                    {{-- <td>
                        {{ optional($user->salon)->id ?? 'No Salon' }}
                    </td> --}}
